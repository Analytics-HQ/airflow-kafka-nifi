...
public class KafkaStreamsExample {
    ...
    public static void main(String[] args) {
        ...
        builder.stream("used-car-colors-2", Consumed.with(Serdes.String(), Serdes.String())).mapValues(value -> {
            StringBuilder sb = new StringBuilder();
            sb.append(value);
            return sb.reverse().toString();
        }).to("used-car-colors-output", Produced.with(Serdes.String(), Serdes.String()));
